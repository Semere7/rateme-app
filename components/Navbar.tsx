...
const NAV_LINKS = [
  { href: '/dashboard',    label: 'Dashboard',    mobileHidden: false },
  { href: '/achievements', label: 'Achievements', mobileHidden: true  },
  { href: '/compare',      label: 'Compare',      mobileHidden: true  },
  { href: '/salary',       label: 'Salary',       mobileHidden: true  },
  { href: '/friends',      label: 'Friends',      mobileHidden: false },
]
